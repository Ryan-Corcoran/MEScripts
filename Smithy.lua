...
local tasks = {
    ...
    -- { metalType = "ELDER_RUNE", itemType = "FULL_HELM", itemLevel = "BURIAL", amount = 1 },
     { metalType = "ELDER_RUNE",      itemType = "ARMOURED_BOOTS",  itemLevel = 0,        amount = 2 },
     { metalType = "ELDER_RUNE",      itemType = "ARMOURED_BOOTS",  itemLevel = 1,        amount = 2 },
     { metalType = "ELDER_RUNE",      itemType = "ARMOURED_BOOTS",  itemLevel = 2,        amount = 2 },
     { metalType = "ELDER_RUNE",      itemType = "ARMOURED_BOOTS",  itemLevel = 3,        amount = 2 },
     { metalType = "ELDER_RUNE",      itemType = "ARMOURED_BOOTS",  itemLevel = 4,        amount = 2 },
     { metalType = "ELDER_RUNE",      itemType = "ARMOURED_BOOTS",  itemLevel = 5,        amount = 2 },
	 { metalType = "ELDER_RUNE",      itemType = "GAUNTLETS",  itemLevel = 0,        amount = 2 },
     { metalType = "ELDER_RUNE",      itemType = "GAUNTLETS",  itemLevel = 1,        amount = 2 },
     { metalType = "ELDER_RUNE",      itemType = "GAUNTLETS",  itemLevel = 2,        amount = 2 },
     { metalType = "ELDER_RUNE",      itemType = "GAUNTLETS",  itemLevel = 3,        amount = 2 },
     { metalType = "ELDER_RUNE",      itemType = "GAUNTLETS",  itemLevel = 4,        amount = 2 },
     { metalType = "ELDER_RUNE",      itemType = "GAUNTLETS",  itemLevel = 5,        amount = 2 },
	 { metalType = "ELDER_RUNE",      itemType = "PLATEBODY",  itemLevel = 0,        amount = 2 },
     { metalType = "ELDER_RUNE",      itemType = "PLATEBODY",  itemLevel = 1,        amount = 2 },
     { metalType = "ELDER_RUNE",      itemType = "PLATEBODY",  itemLevel = 2,        amount = 2 },
     { metalType = "ELDER_RUNE",      itemType = "PLATEBODY",  itemLevel = 3,        amount = 2 },
     { metalType = "ELDER_RUNE",      itemType = "PLATEBODY",  itemLevel = 4,        amount = 2 },
     { metalType = "ELDER_RUNE",      itemType = "PLATEBODY",  itemLevel = 5,        amount = 2 },
	 { metalType = "ELDER_RUNE",      itemType = "PLATELEGS",  itemLevel = 0,        amount = 2 },
     { metalType = "ELDER_RUNE",      itemType = "PLATELEGS",  itemLevel = 1,        amount = 2 },
     { metalType = "ELDER_RUNE",      itemType = "PLATELEGS",  itemLevel = 2,        amount = 2 },
     { metalType = "ELDER_RUNE",      itemType = "PLATELEGS",  itemLevel = 3,        amount = 2 },
     { metalType = "ELDER_RUNE",      itemType = "PLATELEGS",  itemLevel = 4,        amount = 2 },
     { metalType = "ELDER_RUNE",      itemType = "PLATELEGS",  itemLevel = 5,        amount = 2 },
	 { metalType = "ELDER_RUNE",      itemType = "FULL_HELM",  itemLevel = 0,        amount = 2 },
     { metalType = "ELDER_RUNE",      itemType = "FULL_HELM",  itemLevel = 1,        amount = 2 },
     { metalType = "ELDER_RUNE",      itemType = "FULL_HELM",  itemLevel = 2,        amount = 2 },
     { metalType = "ELDER_RUNE",      itemType = "FULL_HELM",  itemLevel = 3,        amount = 2 },
     { metalType = "ELDER_RUNE",      itemType = "FULL_HELM",  itemLevel = 4,        amount = 2 },
     { metalType = "ELDER_RUNE",      itemType = "FULL_HELM",  itemLevel = 5,        amount = 2 },
     { metalType = "ELDER_RUNE",      itemType = "SET",  itemLevel = "BURIAL",        amount = 4 }
